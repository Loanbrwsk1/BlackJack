...
A browser-based Blackjack game built with vanilla HTML, CSS and JavaScript. The game runs entirely client-side with no dependencies. Based on the MVC architecture.
